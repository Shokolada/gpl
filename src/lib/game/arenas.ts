...
export const ARENAS: Arena[] = [
  // Geopolitical
  {
    ...
    sideA: { name: 'USA', color: '#3B82F6', secondaryColor: '#1E40AF', clipPolygon: SHAPES.usa, flagStripes: ['#b22234', '#ffffff', '#3c3b6e'] },
    sideB: { name: 'Iran', color: '#EF4444', secondaryColor: '#991B1B', clipPolygon: SHAPES.iran, flagStripes: ['#009934', '#ffffff', '#c8102e'] },
    totalPixels: 10000,
    sideACaptured: 0,
    sideBCaptured: 0,
    status: 'active',
  },
  {
    ...
    name: 'Israel vs Iran',
    category: 'geopolitical',
    sideA: { name: 'Israel', color: '#2563EB', secondaryColor: '#1D4ED8', clipPolygon: SHAPES.israel, flagStripes: ['#0038b8', '#ffffff', '#0038b8'] },
    sideB: { name: 'Iran', color: '#DC2626', secondaryColor: '#991B1B', clipPolygon: SHAPES.iran, flagStripes: ['#009934', '#ffffff', '#c8102e'] },
    totalPixels: 10000,
    sideACaptured: 0,
    sideBCaptured: 0,
    status: 'active',
  ...
  // Sports
  {
    ...
    category: 'sports',
    sideA: { name: 'The Argentine Magician', color: '#60A5FA', secondaryColor: '#2563EB', clipPolygon: SHAPES.argentina, flagStripes: ['#74acdf', '#ffffff', '#74acdf'] },
    sideB: { name: 'The Portuguese Rocket', color: '#F87171', secondaryColor: '#DC2626', clipPolygon: SHAPES.portugal, flagStripes: ['#006600', '#ff0000'] },
    totalPixels: 10000,
    sideACaptured: 0,
    sideBCaptured: 0,
    status: 'active',
